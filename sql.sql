...
INSERT INTO `tp_client` VALUES ('6', '1', '6', '某某国际有限公司', '美国洛杉矶', '', 'http://www.luoshanji.com', '35', '10', '16', '12', '56', '47', '59', '医疗行业。。', '没了。。。', '1', null, '0', '2014-01-07 19:42:29', '2014-01-07 19:42:29');
...
-- Records of tp_role
-- ----------------------------
INSERT INTO `tp_role` VALUES ('1', '超级管理员', '拥有全部权限，网站主要管理人员', '2,3,4,5,7,8,9,10,12,13,14,15,21,22,23,24,25,26,27,28,18,19,20,82,83,29,30,32,33,52,53,35,36,37,38,39,40,41,42,43,77,45,46,47,48,49,50,51,60,61,62,63,65,66,67,68,69,70,71,72,73,74,75,76,78,79,80,81,', '0', '2013-12-08 17:13:02');
...
-- ----------------------------
INSERT INTO `tp_statis` VALUES ('2', '1', '1390312325');
...
-- Records of tp_user
-- ----------------------------
INSERT INTO `tp_user` VALUES ('1', 'admin', '10470c3b4b1fed12c3baac014be15fac67c6e815', 'gu@qq.com', '1', '0', '2,3,4,5,7,8,9,10,12,13,14,15,21,22,23,24,25,26,27,28,18,19,20,82,83,29,30,32,33,52,53,35,36,37,38,39,40,41,42,43,77,45,46,47,48,49,50,51,84,60,61,62,63,65,66,67,68,69,70,71,72,73,74,75,76,78,79,80,81,85,', '超级管理员', '本机地址.IAMLE.COM', '219', '127.0.0.1', '2014-01-21 21:36:11', '2013-12-08 17:18:54');
INSERT INTO `tp_user` VALUES ('2', 'LITTLE', '10470c3b4b1fed12c3baac014be15fac67c6e815', 'LITTLE@qq.com', '2', '0', '2,7,12,21,25,18,19,29,32,35,', '普通管理员', '本机地址.IAMLE.COM', '3', '127.0.0.1', '2014-01-08 22:35:04', '2013-12-08 17:19:17');
INSERT INTO `tp_user` VALUES ('5', '小峰', '10470c3b4b1fed12c3baac014be15fac67c6e815', 'xiaofeng@qq.com', '1', '0', '2,3,4,5,7,8,9,10,12,13,14,15,21,22,23,24,25,26,27,28,18,19,20,82,83,29,30,32,33,52,53,35,36,37,38,39,40,41,42,43,77,45,46,47,48,49,50,51,60,61,62,63,65,66,67,68,69,70,71,72,73,74,75,76,78,79,80,81,', '', null, '6', '127.0.0.1', '2014-01-01 17:20:46', '2013-12-29 20:44:29');
...
--------------------------------
-- Table structure for `tp_thread`
--------------------------------
DROP TABLE IF EXISTS `tp_thread`;
CREATE TABLE `tp_thread` (
  `ID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `Tid` int(10) DEFAULT '0' COMMENT '线程ID',
  `Class` varchar(1000) DEFAULT NULL COMMENT '线程类',
  `ThreadCount` tinyint(4) DEFAULT NULL COMMENT '线程个数',
  `SleepTime` tinyint(4) DEFAULT NULL COMMENT '休眠时间',
  `Status` tinyint(4) DEFAULT '0',
  `Content` varchar(1000) DEFAULT NULL COMMENT '详细描述',
  `Dtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`ID`)
...
CREATE TABLE `tp_batch` (
  `ID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `Bid` int(10) DEFAULT '0' COMMENT '批量ID',
  `Class` varchar(1000) DEFAULT NULL COMMENT '线程类',
  `ThreadCount` tinyint(4) DEFAULT NULL COMMENT '线程个数',
  `SleepTime` tinyint(4) DEFAULT NULL COMMENT '休眠时间',
  `Status` tinyint(4) DEFAULT '0',
